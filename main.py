...
alexey = np.array([5, 3])
sashan = np.array([5, 3])
icebaby = np.array([5, 3])
print("Эмили: %.3f" % network.feedforward(emily)) # 0.951 - Ж
print("Фрэнк: %.3f" % network.feedforward(frank)) # 0.039 - М
print("Дядя Богдан: %.3f" % network.feedforward(bogdan)) 
print("Вадис: %.3f" % network.feedforward(bogdan))
print("Алексей: %.3f" % network.feedforward(bogdan))
print("Сашаний: %.3f" % network.feedforward(bogdan))
print("Айс Бэйба: %.3f" % network.feedforward(bogdan))